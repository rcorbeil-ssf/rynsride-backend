#!/bin/bash
# this test script should find a match, end locations are within the 2 mile radius, end locations are 1.5 miles away
...
curl -X POST --header "Content-Type: application/json" --header "Accept: application/json" -d '{"postedTrip":{  "driverId": "1",
  "startAddress": {"street": "456 Ocean Blvd", "city": "Oceanside", "state": "CA", "zip": "92054"},
  "startGeopoint": {
    "lat": 33.183633,
    "lng": -117.369560
  },
  "destAddress": {"street": "123 Main St", "city": "San Diego", "state": "CA", "zip": "92173"},
  "destGeopoint": {
    "lat": 32.552591,
    "lng": -117.043562
  },
...
curl -X POST --header "Content-Type: application/json" --header "Accept: application/json" -d '{"requestedRide":{
  ...
  "destAddress": {"street": "1326 Otono St", "city": "San Diego", "state": "CA", "zip": "92154"},
  "destGeopoint": {
    "lat": 32.572802,
    "lng": -117.052205
  },
